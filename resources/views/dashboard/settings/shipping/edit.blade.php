...
@section('content')
  <div class="app-content content">
                ...
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="">{{__('admin/shipping.main')}}</a></li>
                                <li class="breadcrumb-item active">{{__('admin/shipping.shipping method')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form">{{__('admin/shipping.edit shipping method')}}</h4>
    ...
    @include('dashboard.includes.alrets.success')
    @include('dashboard.includes.alrets.errors')
            ...
            <form class="form" action="{{route('update.shipping.method',$shippingMethod-> id)}}"
                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="projectinput1">{{__('admin/shipping.delivery value' )}}</label>
